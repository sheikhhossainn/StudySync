...
# Use DATABASE_URL if available (for cloud deployments), otherwise use individual settings
...
PAYMENT_APIS = {
    ...
    'ROCKET': {
        'BASE_URL': config('ROCKET_BASE_URL', default='https://sandbox.rocket.com.bd/api'),
        'MERCHANT_ID': config('ROCKET_MERCHANT_ID', default=''),
        'API_KEY': config('ROCKET_API_KEY', default=''),
        'SECRET_KEY': config('ROCKET_SECRET_KEY', default=''),
    },
    'STRIPE': {
